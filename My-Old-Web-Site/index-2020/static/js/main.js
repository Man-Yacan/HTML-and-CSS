...
(function($) {
    ...
    // 建站时间计算
    setInterval(function countDown() { var oldTime = new Date('2017/07/02 12:00:00'),
            nowTime = new Date();
        nowTime = nowTime.getTime();
        oldTime = oldTime.getTime(); var timeDifference = nowTime - oldTime,
        ...
        document.getElementById('countDownSeconds').innerHTML = seconds; }, 1000);
