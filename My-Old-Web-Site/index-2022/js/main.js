...
const add_id = "khzykxqapa1whstk"; // app_id
const app_secret = "N1EycHFZUTh4eVBRSjd2OXFqdjAxZz09"; // app_secret
const key = "fbcb38c09480493895c5da9d049f73cc" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("白日梦想家");
        $("#change1").html("開拓視野，沖破艱險，洞悉所有，貼近生活，尋找真愛，感受彼此。");
    }
});
...
//控制台输出
console.clear();
console.log("\n %c 曼亚灿的个人网站 | www.manyacan.com | 个人引导页 ", "color:#eee;background:#444;padding:5px 0;");